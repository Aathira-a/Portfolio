...
function Contact() {
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 left-1/3 w-[40vw] h-[40vw] bg-red-500/5 rounded-full blur-[120px] animate-pulse" />
      ...
      {/* ─── MAIN CONTAINER ─── */}
      <div className="relative z-10 max-w-5xl mx-auto grid md:grid-cols-5 gap-14 items-center px-6 w-full pb-12">
        ...
        <div className="md:col-span-2 space-y-6 text-center md:text-left">
          ...
          <p className="text-red-200/50 text-lg leading-relaxed font-light max-w-md">
            ...
            projects, or just to connect and communicate.
          </p>
        ...
        <div className="md:col-span-3 space-y-6 w-full">
          ...
          {[
            ...
            {
              title: "Email",
              value: "athiragowri06rs@gmail.com",
            },
            {
              title: "Location",
            ...
            <div
              key={i}
              className="group relative p-5 rounded-2xl backdrop-blur-xl
            ...
            >
              ...
              <p className="text-red-100/50 text-lg mt-1 font-light tracking-wide group-hover:text-slate-200 transition">
                {item.value}
              </p>
